...
with open("C:\\Users\\Kaveesh\\Downloads\\test_cursor\\test_cursor\\tea_models_project\\ExtraTrees_model.pkl", "rb") as file:
    model = pickle.load(file)

# Load the dataset to get the LabelEncoder (to match training labels)
import pandas as pd
data = pd.read_csv("C:\\Users\\Kaveesh\\Downloads\\test_cursor\\test_cursor\\tea_models_project\\tea_aroma_balanced.csv")
...
sample_input = [5028.0, 2578.0, 1381.0, 992.0, 4115.0, 9698.0, 12879.0]
